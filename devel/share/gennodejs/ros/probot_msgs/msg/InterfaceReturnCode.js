...
class InterfaceReturnCode {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new InterfaceReturnCode(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new InterfaceReturnCode(null);
...
InterfaceReturnCode.Constants = {
  SUCCESS: 1,
  FAILURE: -1,
}

module.exports = InterfaceReturnCode;
